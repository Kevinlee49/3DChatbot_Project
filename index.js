...
const apiKey = "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" // api key 발급받기 from openai
...
app.post('/fortuneTell', async function (req, res) {
    ...
    let messages = [
        ...
        // let 안의 list 요소들이 javascript 형태로 들어가기 때문에 json 형태로 바꿔줘야함
    ]
    ...
    while (userMessages.length != 0 && assistantMessages != 0) {
        messages.push(
            '{role: "user", content: "' + String(userMessages.shift()).replace(/\s*/g, "") + '"},'
